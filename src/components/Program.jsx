...
export default function Program(props) {
  ...
  function getExercisePrograms() {
    ...
    axios
      .get(`/workout?programId=${props.displayedProgramId}&date=${props.date}`)
      .then((response) => {
  ...
  function FavoriteButton() {
    axios
      .put(`/favorite-regimen?id=${props.displayedProgramId}`)
      .then((response) => {
        // console.log(response.data)
        axios.get("/this-weeks-program").then((response) => {
  ...
  return (
    <>
      ...
      >
        <Modal.Header
          closeButton
          onHide={() => setShow(false) & setDisplayedProgramId(-1)}
        >
          ...
          {props.isFav ? (
            ...
            <Button>
              <i
                ...
                style={{ fontSize: "1.25rem", color: "#D05353" }}
